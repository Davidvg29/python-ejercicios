...
rutaGraficoEstaisticaGenero = os.path.join(rutaBase, "graficoEstadisticaGeneros.png")
    ...
    if validacion != "":
        ...
        while len(listaMovimientos) > cont:
            if str(idEntry.get()) == str(listaMovimientos[cont][0]):
                ...
                listaMovimientos[cont][5] = areaUtilizadaEntry.get()
            cont+=1
...
def verEstadisticaGenero():
    global rutaGraficoEstaisticaGenero
    numMasculinos = 0
    numFemeninos = 0
    ...
    plt.savefig(rutaGraficoEstaisticaGenero)
    plt.show()
